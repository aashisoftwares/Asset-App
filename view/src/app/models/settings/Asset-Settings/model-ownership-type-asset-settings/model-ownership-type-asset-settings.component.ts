...
import { OwnershipTypesComponent } from 'src/app/Components/Settings/Asset-Settings/SubComponents/ownership-types/ownership-types.component';
...
@Component({
  selector: 'app-model-ownership-type-asset-settings',
  templateUrl: './model-ownership-type-asset-settings.component.html',
  styleUrls: ['./model-ownership-type-asset-settings.component.css']
})
export class ModelOwnershipTypeAssetSettingsComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<OwnershipTypesComponent>,
    ...
    ngOnInit(): void {
      this.Form = new FormGroup({
        ...
        Ownership_Type_Id: new FormControl(0),
    ...
    fetchDataIntoForm(){
      ...
      if(this.setValueToForm){
        this.Form.patchValue(this.data.ownershipModel);
        this.Form.controls.Created_By.setValue(this.data.ownershipModel.Created_By._id);
    ...
    onSubmit(mode) {
      if(mode=='Submit'){
        this.methodName=this.serviceName.ownership_Create;
      }else{
        this.methodName=this.serviceName.ownership_Edit;
        this.Form.controls.Ownership_Type_Id.setValue(this.data.ownershipModel._id);
      }
